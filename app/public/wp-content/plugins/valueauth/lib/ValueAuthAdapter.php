...
class ValueAuthAdapter {
	...
	function __construct() {
		...
		wp_register_style( 'vauth-style', plugins_url( 'public/css/style.css', __FILE__ ) );
		wp_register_script( 'vauth-management-console', plugins_url( 'public/dist/js/managementConsole.js', __FILE__ ) );
		wp_register_script( 'vauth-code-input', plugins_url( 'public/dist/js/codeInput.js', __FILE__ ) );
